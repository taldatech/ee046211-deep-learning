...
|`ee046211_tutorial_03_`<br>`optimization_gradient_descent.ipynb/pdf`|Unimodal functions, Convexity, Hessain, Gradient Descent, SGD, Learning Rate, LR Scheculing / Annealing, Momentum, Nesterov Momentum, Adaptive Learning Rate Methods, Adagrad, RMSprop, Adam, AdaBelief, MADGRAD, Adan|<a href="https://youtu.be/NguufamjuH4?si=I3v6Zi6VJKblt9d3">Video Link - Part 1</a><br><a href="https://youtu.be/3Yl2XMInUkE?si=JGtYN-6v9aNAbIIR">Video Link - Part 2</a>|
